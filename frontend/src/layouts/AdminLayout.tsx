  ...
  return (
    <div style={{ minHeight: '100vh', background: '#FDFDF7', display: 'flex', flexDirection: 'column' }}>
      ...
      <header style={{
        ...
        background: '#FDFDF7', borderBottom: '1px solid #E8E8E3',
      }}>
        <div style={{ maxWidth: contentWidth, margin: '0 auto', padding: '0 24px', height: 56, display: 'flex', alignItems: 'center', gap: 24 }}>
          ...
          <div style={{
            ...
            padding: 4, background: '#F2F2ED', borderRadius: 10, overflowX: 'auto',
          }}>
            {menuItems.map((item) => {
              ...
              return (
                <button
                  ...
                  onMouseEnter={(e) => {
                    if (!isActive) (e.currentTarget as HTMLElement).style.color = '#3d3d3a'
                  }}
                  onMouseLeave={(e) => {
                    if (!isActive) (e.currentTarget as HTMLElement).style.color = '#73726c'
                  }}
                >
                  {item.label}
                </button>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexShrink: 0 }}>
            ...
            <button
              ...
              style={{
                ...
                color: '#8E8E8E', fontSize: 13, padding: '4px 8px', borderRadius: 5,
